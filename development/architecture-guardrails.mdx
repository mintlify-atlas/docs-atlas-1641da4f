...
description: "Chronos Atlas uses an automated architecture check script to detect cross-feature deep imports and business logic leaking into the Shared kernel — enforcing clean vertical slice boundaries."
---
