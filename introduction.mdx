---
title: "Chronos Atlas: Local-First Worldbuilding Desktop App"
sidebarTitle: "Introduction"
description: "A local-first desktop app for writers — manage entities, maps, timelines, conlangs, and prose, all stored in SQLite WASM on your own machine with no cloud."
---
...
<CardGroup cols={2}>
  <Card title="World Bible" icon="book-open" href="/features/world-bible">
  ...
  <Card title="Timelines" icon="clock" href="/features/timeline">
  ...
  <Card title="Linguistics / Conlangs" icon="language" href="/features/linguistics">
  ...
  <Card title="Relationship Graph" icon="diagram-project" href="/features/graph">
