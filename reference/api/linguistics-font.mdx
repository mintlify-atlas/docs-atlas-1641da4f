...
description: "POST /linguistics/font/compile takes SVG glyph paths plus font metadata and returns a compiled TrueType .ttf file ready for your constructed language."
---
