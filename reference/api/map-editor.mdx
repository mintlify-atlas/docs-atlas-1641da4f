...
description: "REST endpoints under /mapeditor for uploading map images, downloading them, uploading from URL, and creating blank map canvases for Chronos Atlas world maps."
---
