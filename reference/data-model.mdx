...
description: "The Chronos Atlas data model defines Proyectos, Carpetas, Entidades, Plantillas, Valores, Eventos, and more — all persisted in a local SQLite file via OPFS."
---
