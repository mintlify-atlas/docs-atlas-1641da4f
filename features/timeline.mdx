...
The Timeline module exposes a full set of management methods via `TimelineUseCase`:
...
Individual events within a track are managed through a dedicated set of methods:
